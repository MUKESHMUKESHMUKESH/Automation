...
await managerPage.locator('input[placeholder="Search"]').fill(tenant.firstName);
...
await managerPage.locator('input[placeholder="Enter first name"]').fill('manager');
await managerPage.locator('input[placeholder="Enter last name"]').fill('N');
